        ...
        <div class="col">
            <figure class="card position-relative border-1 shadow-sm bg-light-subtle py-3 p-0 p-lg-4 mt-4 mb-0 ms-xl-5 animate__animated animate__fadeIn">
                ...
                <blockquote class="card-body mt-2 mb-0">
                    ...
                    <p class="text-end"><strong>MVC::UI</strong> est un package open-source proposant un squelette de
                    ...
                    <p class="text-end">Ce package fournit un ensemble de fonctionnalités permettant de développer
                        rapidement une
                        ...
                        etc.</p>
                    <p class="text-end">Le squelette MVC::UI suit les meilleures pratiques de développement et est
                        hautement
                    ...
                    <p class="text-end">En utilisant MVC::UI comme base de développement pour votre application web,
                        vous pouvez
                    ...
                    <p class="text-end">En résumé, MVC::UI est un package open-source de haute qualité pour les
                        développeurs
